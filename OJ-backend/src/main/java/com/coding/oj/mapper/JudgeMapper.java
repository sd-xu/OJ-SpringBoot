...
public interface JudgeMapper {
    ...
    List<Judge> selectByAllParam(@Param("userId") Integer userId, @Param("pid") Long pid, @Param("status") Integer status, @Param("language") String language, @Param("title") String title);
